...
namespace Test
{
    public static class Program 
    {
        ...
        public static void Main()
        {
            ...
            conn = Object_Classification.Class1.conn;
        ...
        private static bool MainMenu()
        {
            ...
            {
                case "1":
                    Object_Classification.Class1.AddTags(Object_Classification.Class1.trainingApi, Object_Classification.Class1.project);
                    return true;
                case "2":
                    Object_Classification.Class1.UploadImages(Object_Classification.Class1.trainingApi, Object_Classification.Class1.project);
                    return true;
                case "3":
                    Object_Classification.Class1.TrainProject(Object_Classification.Class1.trainingApi, Object_Classification.Class1.project);
                    return true;
                case "4":
                    Object_Classification.Class1.TakePhotoThreading();
                    return true;
                case "5":
                    //While an item is on the scale
                    while (Object_Classification.Class1.weighingScaleStatus == 1)
                    {
                        Object_Classification.Class1.TestIteration(Object_Classification.Class1.predictionApi, Object_Classification.Class1.project);
                        Console.Write("Another image? (1 or 0): ");
                        Object_Classification.Class1.weighingScaleStatus = Convert.ToInt32(Console.ReadLine());
                    }
                    return true;
                case "6":
                    Object_Classification.Class1.PublishIteration(Object_Classification.Class1.trainingApi, Object_Classification.Class1.project);
                    return true;
                case "9":
                    Object_Classification.Class1.AddTags(Object_Classification.Class1.trainingApi, Object_Classification.Class1.project);
                    Object_Classification.Class1.TakePhotoThreading();
